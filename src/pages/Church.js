  ...
  return (
    <ChurchContainer>
      ...
      <section style={{ position: "relative" }}>
        <div class="custom-shape-divider-bottom-1641648828">
          <svg
            data-name="Layer 1"
      ...
      <section style={{ position: "relative" }}>
        <div class="custom-shape-divider-top-1641649200">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1200 120"
      ...
      <section style={{ position: "relative" }}>
        <div class="custom-shape-divider-bottom-1641649664">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1200 120"
      ...
      <section style={{ position: "relative" }}>
        <div class="custom-shape-divider-top-1641651066">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1200 120"
