  ...
  return (
    <HomeContainer>
      ...
      <section style={{ position: "relative" }}>
        <div class="custom-shape-divider-bottom-1641632424">
          <svg
            data-name="Layer 1"
      ...
      <AboutComponent />
      <section style={{ position: "relative" }}>
        <div class="custom-shape-divider-top-1641633212">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1200 120"
      ...
      <ConferenceComponent />
      <section style={{ position: "relative" }}>
        <div class="custom-shape-divider-bottom-1641634686">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1200 120"
      ...
      <FeaturedComponents />
      <section style={{ position: "relative" }}>
        <div class="custom-shape-divider-top-1641635056">
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1200 120"
